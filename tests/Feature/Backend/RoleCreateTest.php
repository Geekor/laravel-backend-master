...
class RoleCreateTest extends TestAuthCase
{
    ...
    protected $my_testing_params = [
        ...
        'title' => 'DUMMY 用户',
        'level' => 0,
        'description' => 'DUMMY 测试用户',
        'permissions' => ['user:article-b']
    ];

    /*
    |--------------------------------------------------------------------------
    | 角色信息可以被操作的选项： 'name', 'title', 'level', 'description', 'permissions'
    |--------------------------------------------------------------------------
    */
