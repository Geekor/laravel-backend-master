...
use Geekor\BackendMaster\Tests\Base\Traits\AuthValidByNormalUser;

class NormalUserGetInfoTest extends TestAuthCase
{
    use AuthInvalidCheck;
    use AuthValidByNormalUser;
    ...
    /** 当前测试的 API */
    protected $my_testing_api = '/api/auth/info';
